...
class Player {
  ...
  constructor(x: integer, y: integer, game: any) {
    ...
    const recRight = game.matter.bodies.rectangle(16, 0, 10, 27, { isSensor: true, label: 'playerRight' });
    const recLeft = game.matter.bodies.rectangle(-16, 0, 10, 27, { isSensor: true, label: 'playerLeft' });
