...
- kill other objects that fall down holes and hit world bounds, currently objects not destroyed (resolved)
- level 33 (26 here) has a bug with the fast burning? (should be resolved)
- bug if spider falls while at edge it can get stuck (should be resolved)
